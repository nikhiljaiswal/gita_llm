...
if __name__ == "__main__":
    ...
    if q: # if the user entered a question and hit enter
        ...
        if 'vs' in st.session_state: # if there's the vector store (user uploaded, split and embedded a file)
            ...
            print('chat_context before',chat_context)
            answer, chat_context = ask_with_memory(vector_store, q, chat_history=chat_context, k=k)
            st.session_state.chat_context = chat_context

            print('chat_context after',st.session_state.chat_context)
            ...
            print('Answer: ',answer)
            print('chat_history final',chat_context)
            ...
            print('chat_history final2',chat_context)
            ...
            print('chat_history final3',chat_context)
